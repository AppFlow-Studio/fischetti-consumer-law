...
export const firms: Firm[] = [
    ...
    },
    {
        ...
        description: "From our Port St. Lucie area office, we assist clients across the Treasure Coast and surrounding regions with consumer rights violations. Many clients contact us after discovering errors on their credit reports, being denied employment due to inaccurate background checks, or receiving persistent robocalls and spam texts. Consumer Law Florida helps Port St. Lucie clients pursue compensation for violations involving credit bureaus, debt collectors, and telemarketers. Our statewide practice model allows you to get legal help quickly without unnecessary in-person meetings.",
