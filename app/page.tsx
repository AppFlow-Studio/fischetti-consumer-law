      ...
      <div className="max-w-8xl mx-auto">
        ...
        <div className="mb-12 w-full flex flex-col xl:flex-row items-center mt-12 justify-center mx-auto px-4 xl:px-8">
          <ProfileCard
            ...
            description="Courtroom warrior from day one. Michael began his career as a defense attorney at the Broward County Public Defender's Office, where he handled both misdemeanor and felony cases, led busy misdemeanor divisions, and tried cases from day one. He later transitioned to civil and consumer litigation, bringing that trial-tested intensity to FCRA credit reporting and background check cases, FDCPA debt collection matters, and TCPA robocall and spam text claims. Michael founded Fischetti Law Group after years of watching big firms prioritize profits over people. His philosophy? Listen first, fight hard, communicate always. Recognized for excellence, Michael holds an A+ rating from the Better Business Bureau, a Trust badge for Attorney At Law, and is featured on Elite Lawyer."
